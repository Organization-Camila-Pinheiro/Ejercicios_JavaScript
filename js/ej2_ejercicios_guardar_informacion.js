...
duration = 93;
awards = true;
document.write("La película es " + movieTitle + ", el director es el " + director + ", su año de lanzamiento fue en " + yaerRelease +
" y tiene " + duration + " minutos de duración.")
document.write("</br>");
document.write("Tiene premios?: " + awards);
...
document.write("DEstino de viaje favorito fue " + destination + ", está en  " + country + ", su clima predominante es " + weather +
", tiene " + numberPopulation 
...
destination = "Málaga";
country = "Espana";
weather = "Mediterraneo";
numberPopulation = 571.026;
places = "arquitetura";
coast = true;
urban = true;
...
document.write("</br>");
document.write("Predio dela gasolina: " + priceGas);
document.write("</br>");
